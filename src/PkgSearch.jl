...
function render(p::Dict{AbstractString, Any})
  ...
  println("-----------------------------------------------------")
  println(is_official_package(p["attributes"]["name"]) ? "Official package" : "Unofficial package")
  println("-----------------------------------------------------")
  println(p["attributes"]["url"])
  println("-----------------------------------------------------")
...
function render_package(p::Dict{AbstractString, Any})
  ...
  println(p["url"])
  println("-----------------------------------------------------")
  println(is_official_package(p["name"]) ? "Official package" : "Unofficial package")
  println("-----------------------------------------------------")
